...
import { TrendingUp, Users, Target, BookOpen, Sparkles } from 'lucide-react';
        ...
        <aside className="w-full lg:w-80 space-y-4 lg:space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 lg:p-6 border border-gray-200 dark:border-gray-700 shadow-sm">
                <div className="flex items-center justify-between mb-3 lg:mb-4">
                    ...
                    <Link to="/explore" className="text-xs lg:text-sm text-primary-600 hover:underline">
                        See all
                    </Link>
                </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 lg:p-6 border border-gray-200 dark:border-gray-700 shadow-sm">
                ...
                <div className="space-y-2 lg:space-y-3">
                    {trendingTopics.map((topic, index) => (
                        <Link
                            key={index}
                            to={`/explore?search=${encodeURIComponent(topic.tag)}`}
