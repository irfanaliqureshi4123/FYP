...
const Button = ({
    ...
    const variants = {
        ...
        outline: 'bg-transparent border-2 border-gray-300 hover:border-primary-500 hover:bg-primary-50 text-gray-700 dark:border-gray-600 dark:hover:border-primary-500 dark:hover:bg-primary-900/20 dark:text-gray-300',
